...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ollama-cloud-pp-cli",
		Short: "Manage ollama-cloud resources via the ollama-cloud API",
		Long: `Manage ollama-cloud resources via the ollama-cloud API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'ollama-cloud-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ollama-cloud-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ollama-cloud-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEmbeddingsCmd(flags))
	rootCmd.AddCommand(newDoctorCmd(flags))
	rootCmd.AddCommand(newAdviseCmd(flags))
	rootCmd.AddCommand(newCompareCmd(flags))
	rootCmd.AddCommand(newAdviseReplayCmd(flags))
	rootCmd.AddCommand(newCostTraceCmd(flags))
	...
	rootCmd.AddCommand(newPsPromotedCmd(flags))
