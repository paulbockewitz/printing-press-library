...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/payments/revenuecat/internal/config"
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "revenuecat-pp-cli",
		Short: `Revenuecat CLI — Every RevenueCat v2 endpoint, plus a local database, offline search, and revenue/churn/refund intelligence the dashboar…`,
		Long: `Revenuecat CLI — Every RevenueCat v2 endpoint, plus a local database, offline search, and revenue/churn/refund intelligence the dashboar…
...
Health check: run 'revenuecat-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("revenuecat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'revenuecat-pp-cli profile list')")
	...
	rootCmd.AddCommand(newOfferingsCmd(flags))
	rootCmd.AddCommand(newPackagesCmd(flags))
	rootCmd.AddCommand(newPaywallsCmd(flags))
	...
	rootCmd.AddCommand(newVirtualCurrenciesCmd(flags))
	...
	rootCmd.AddCommand(newNovelEntitlementRollupCmd(flags))
	...
	rootCmd.AddCommand(newNovelTrialFunnelCmd(flags))
	rootCmd.AddCommand(newNovelWebhookAuditCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAuditLogsPromotedCmd(flags))
	rootCmd.AddCommand(newChartsPromotedCmd(flags))
	rootCmd.AddCommand(newCollaboratorsPromotedCmd(flags))
	rootCmd.AddCommand(newMediaAssetsPromotedCmd(flags))
