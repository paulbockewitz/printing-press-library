...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ankiweb-pp-cli",
		Short: `AnkiWeb CLI to search, rank, and download shared decks, read cloud-synced decks, and keep an offline catalog`,
		Long: `AnkiWeb CLI — The only terminal-native way to search, rank, and download AnkiWeb shared decks — and read your cloud-synced decks — with an offline catalog no other Anki tool has.
...
Health check: run 'ankiweb-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ankiweb-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ankiweb-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSharedCmd(flags))
	...
	rootCmd.AddCommand(newDecksCmd(flags))
	...
	rootCmd.AddCommand(newCardsCmd(flags))
	rootCmd.AddCommand(newNoteTypesCmd(flags))
