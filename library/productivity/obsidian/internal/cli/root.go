...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "obsidian-pp-cli",
		Short: "Manage obsidian resources via the obsidian API",
		Long: `Manage obsidian resources via the obsidian API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'obsidian-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	...
	rootCmd.AddCommand(newBrokenCmd(flags))
	rootCmd.AddCommand(newVaultSQLCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDeadendsPromotedCmd(flags))
	...
	rootCmd.AddCommand(newVaultPromotedCmd(flags))
