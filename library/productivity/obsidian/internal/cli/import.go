...
but do not stop the import.`,
  ...
  obsidian-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  obsidian-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | obsidian-pp-cli import <resource> --input -`,
