...
large datasets as it has no memory pressure.`,
  ...
  obsidian-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  obsidian-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  obsidian-pp-cli export <resource> --format jsonl | jq '.id'`,
