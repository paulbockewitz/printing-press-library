...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/productivity/obsidian/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "obsidian-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
