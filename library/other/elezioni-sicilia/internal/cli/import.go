...
but do not stop the import.`,
  ...
  elezioni-sicilia-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  elezioni-sicilia-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | elezioni-sicilia-pp-cli import <resource> --input -`,
