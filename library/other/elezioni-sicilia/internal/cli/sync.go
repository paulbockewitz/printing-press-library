...
Exit codes & warnings:
  ...
  elezioni-sicilia-pp-cli sync

  # Sync specific resources only
  elezioni-sicilia-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  elezioni-sicilia-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  elezioni-sicilia-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  elezioni-sicilia-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  elezioni-sicilia-pp-cli sync --latest-only`,
