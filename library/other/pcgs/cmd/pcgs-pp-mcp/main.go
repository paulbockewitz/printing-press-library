...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/other/pcgs/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "pcgs-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
