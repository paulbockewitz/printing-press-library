...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "meta-ads-pp-cli",
		Short: `Meta Ads CLI — The first agent-native Meta Ads CLI with local SQLite history and compound queries the live API cannot answer.`,
		Long: `Meta Ads CLI — The first agent-native Meta Ads CLI with local SQLite history and compound queries the live API cannot answer.
...
Health check: run 'meta-ads-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'meta-ads-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDecayCmd(flags))
	rootCmd.AddCommand(newNovelFatigueCmd(flags))
	rootCmd.AddCommand(newNovelInventoryCmd(flags))
	rootCmd.AddCommand(newNovelLearningCmd(flags))
	rootCmd.AddCommand(newNovelOverlapCmd(flags))
	rootCmd.AddCommand(newNovelReconcileCmd(flags))
	rootCmd.AddCommand(newNovelStaleCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAdcreativesPromotedCmd(flags))
	...
	rootCmd.AddCommand(newCustomaudiencesPromotedCmd(flags))
	rootCmd.AddCommand(newDeliveryEstimatePromotedCmd(flags))
